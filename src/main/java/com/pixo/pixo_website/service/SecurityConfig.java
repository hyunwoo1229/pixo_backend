...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("https://pixo-frontend.vercel.app", "https://pixo-frontend-git-frontendtest-hynoo20011229-4982s-projects.vercel.app", "https://pixostudio.shop", "https://www.pixostudio.shop", "https://api.pixostudio.shop"));
    ...
    private ClientRegistration googleClientRegistration() {
        return ClientRegistration.withRegistrationId("google")
                .clientId("976640207402-j0nksoh9jhh4dpar8kpli4dvajlvt0qe.apps.googleusercontent.com")
    ...
    private ClientRegistration kakaoClientRegistration() {
        return ClientRegistration.withRegistrationId("kakao")
                .clientId("04bad0ec44b9f6d345952609b276d971")
                .clientAuthenticationMethod(ClientAuthenticationMethod.CLIENT_SECRET_POST)
                .authorizationGrantType(AuthorizationGrantType.AUTHORIZATION_CODE)
